...
def generate_rsa_keys(base64_string, public_key_file, private_key_file):
    ...
    print(f"Clés RSA générées avec succès et sauvegardées dans {public_key_file} et {private_key_file}")

# Utilisation de la fonction
if __name__ == "__main__":
    base64_string = "ee+++ATRIUM+++ed"
    public_key_file = "flag11_atrium_pkey.pem"
    private_key_file = "flag11_atrium_skey.pem"
